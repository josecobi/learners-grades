...
for( let assignment of ag.assignments){
  if(new Date(assignment.due_at) <= new Date()){
    ...
    listOfPastDueAssignments.push(obj);
  } 
} 
console.log(listOfPastDueAssignments)
return listOfPastDueAssignments;
}
...
function getLearnerData(course, ag, submissions) {
  ...
  // I can iterate through the list of unique ids and get a summary per student
